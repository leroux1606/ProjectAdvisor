"""
Score Display Component — renders the overall score gauge and breakdown table.
"""
...
def render_score_header(scores: ScoreBreakdown) -> None:
    ...
    st.markdown(
        ...
        ">
            ...
            "></div>
            <div style="flex: 1;">
                <div style="color: #cbd5e1; font-size: 1rem; font-weight: 600; margin-bottom: 0.5rem;">
                    Overall Assessment
                </div>
