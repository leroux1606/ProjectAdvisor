"""
Recommendations Display Component — renders prioritised, actionable recommendations.
"""
                ...
                <div style="flex: 1;">
                    ...
                    ">
                        ...
                        <span style="
                            ...
                            border-radius:3px;
                            margin-left:auto;
                        ">{item.category.upper()}</span>
                    </div>
                    <div style="color:#94a3b8;font-size:0.87rem;">{item.action}</div>
                </div>
            </div>
            """,
