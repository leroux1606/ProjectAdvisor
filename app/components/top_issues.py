"""
Top Issues Component — renders the top 5 critical/high findings in the summary panel.
"""
...
def render_top_issues(findings: list[Finding]) -> None:
    if not findings:
        st.markdown(
            ...
            ">
                ...
                <div>
                    ...
                    <div style="color:#64748b;font-size:0.78rem;margin-top:2px;">
                        {finding.id} · {finding.severity.value.upper()}
                    </div>
                </div>
            </div>
            """,
